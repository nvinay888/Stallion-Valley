...
function Home({ onNav }) {
  return (
    <div>
      ...
      {/* Courses */}
      <Section>
        <div className="sv-stack-mobile" style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 'var(--space-7)', marginBottom: 'var(--space-7)' }}>
      ...
      <Section tone="sunken">
        <div className="sv-split-57" style={{ alignItems: 'center' }}>
          ...
          <div>
            ...
            <div className="sv-g2" style={{ gap: '0 var(--space-6)' }}>
              {[
